...
!(function ($) {
  ...
  // jadwal dokter isotope and filter
  $(window).on('load', function () {
    var portfolioIsotope = $('.jadwal-container').isotope({
      itemSelector: '.jadwal-item',
      layoutMode: 'fitRows'
    });

    $('#jadwal-filters li').on('click', function () {
      $("#jadwal-filters li").removeClass('filter-active');
      $(this).addClass('filter-active');
